    ...
    <div style="" id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary border-bottom">
        ...
        <div class="container-fluid">
            <h1 class="mt-4">Toko saya (Detail Transaksi)</h1>
            <table id="dataTable" class="table table-striped table-bordered" width="100%" cellspacing="0">
                ...
                <?php 
                    $no = 1;
                    $query = mysqli_query($db, "SELECT * FROM `tborderdetail` INNER JOIN tbjual ON tborderdetail.id_produk = tbjual.id WHERE id_order = '$_GET[id_order]'");
