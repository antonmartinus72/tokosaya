...
// debug unset session "barang"
if ($_GET["debugunset"] ==  1){
  unset($_SESSION['barang']);
  header('Location: pembayaran.php');
}

// if( isset($_POST["querydatasubmit"])) {
//   if($_POST["kode"]>0){
//     "
//       <script>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-dark border-right" id="sidebar-wrapper">
      ...
      <div style="" class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-dark text-white" >Informasi Transaksi</a>
    ...
    <div style="" id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Toko saya (Kasir)</h1>
        <form method="POST" action="query-data-kasir.php" class="container float-left" style="width:30%; ">
          <div class="form-group ">
            <input class="form-control md-3" name="kode" list="datalistOptions" type="text" placeholder="Kode Barang">
            <datalist id="datalistOptions">
                ...
                <?php foreach($tabeljualan as $row) : ?>
                    ...
                    ?>
                    <?php $i++; ?>
                    <input class="form-control md-3" name="increment" type="hidden" value="<?php $i;?>">
                <?php endforeach; ?>
            </datalist>
            <input class="form-control md-3" name="jumlah" type="number" placeholder="Jumlah barang">
            
            <!-- <input class="form-control md-3" name="tunai" type="number" placeholder="Tunai"> -->
            <button type="submit" class="btn btn-primary md-3" name="querydatasubmit">Tambah</button>
            <a href="konfirmasi_pembayaran.php" type="button" class="btn btn-warning md-3" >Bayar sekarang</a>
        ...
        <!-- <form action="" method="get">
          <input type="hidden" name="debugunset" value="1">
          <button type="submit" class="btn btn-danger m-3">!debug_unset_session_"daftar"</button>
        </form> -->
        ...
        <form method="post" class="container float-left" style="width:70%; ">
          <div class="form-group ">
