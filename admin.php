...
// $barang = query("SELECT * FROM tbjual WHERE id = $id")[0];
// $id = $_GET["id"];
            ...
            <tbody>
                ...
                <?php foreach($tabeljualan as $row) : ?>
                    <tr>
                        ...
                        <td><img class="rounded" style="height: 40px" src="img/product_thumb/<?= $row["gambar"]; ?>"></td>
        ...
        <div class="modal-body">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="file" class="form-control" name="gambar" id="gambartambah">
                </div> 
            </div>
...
<script>
  ...
  <!-- Image Poppers -->
  <script src="js/img_popper.js"></script>
